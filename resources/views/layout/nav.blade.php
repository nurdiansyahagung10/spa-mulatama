<nav
    id="navbar"
    class="z-30 sticky top-0 backdrop-blur-lg border-b bg-white/10 dark:bg-base-100/10"
>
    <div
        class="container drawer mx-auto py-3.5 px-2 flex items-center justify-between"
    >
...
{{implode("/",array_slice(explode("/",Request::url()),5)) == 'edit'}}
{{ implode("/",array_slice(explode("/",Request::url()),0,-2)) == url('cabang')}}
            ...
            >
                ...
                <li class="flex justify-end w-full">
                    <label
                        ...
                        class="text-center btn shadow-none bg-transparent focus:bg-transparent hover:bg-transparent drawer-overlay"
                        >X</label
                    >
                </li>
                <li class="flex-grow items">
                    <ul
                        class="bg-transparent w-full text-center text-base-content min-h-full p-4"
                    >
                        <!-- Sidebar content here -->
                    ...
                    <ul
                        class="bg-white w-full text-center text-base-content border-t min-h-full p-4"
                    >
                        <a
                            href=""
                            class="w-full rounded-full leading-none text-white bg-black py-3 px-4 flex items-center justify-center"
                            >Signout</a
                        >
                    </ul>
                </li>
        ...
        <div class="">
            <ul class="inline-flex items-center text-sm space-x-7">
                <ul
                    class="items-center sm:inline-flex hidden space-x-9 border-e pe-7"
                >
                    <li>
                        <a href="{{ url('dashboard') }}">
                            <button
            ...
            @elseif (Request::url() == url('cabang/create'))
                ...
                <li class="sm:px-0 px-3">
                    <button
                        id="theme-toggle"
                        class="align-middle text-black dark:text-white"
                    >
                        <span>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
