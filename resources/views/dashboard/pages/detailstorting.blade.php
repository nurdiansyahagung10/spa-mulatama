        ...
        <table class="table  text-center align-middle">
            <tbody id="anggota-list-body-table" class="text-black/60 dark:text-stone-200">
                    <tr class="dark:border-stone-400 dark:text-stone-300 text-black dark:hover:text-white">
                        ...
                        <td>:</td>
                        <td>{{$storting->created_at->format('Y-m-d')}}</td>
                    </tr>
                    <tr class="dark:border-stone-400 dark:text-stone-300 text-black dark:hover:text-white">
                        <td>nama anggota</td>
                        <td>:</td>
                        <td>{{$storting->anggota->nama}}</td>
                    </tr>
                    <tr class="dark:border-stone-400 dark:text-stone-300 text-black dark:hover:text-white">
                        ...
                        <td>
                            <div class=" flex  h-full mb-6">
                                <div  class='rounded-xl  relative inline-block   text-center p-5  '>
                                    <Image id="foto_pengikat"   src="/Image/{{$storting->anggota->pdl->cabang->id}}/{{$storting->anggota->pdl->id}}/{{$storting->anggota->id}}/{{$storting->anggota->created_at->format('Y-m-d')}}/storting/{{$storting->bukti}}" class="max-w-52 relative   rounded-xl" alt="" width={0} height={0}  objectFit="conten"></Image>
                                </div>
                            </div>
                        </td>
                    </tr>
                    <tr class="dark:border-stone-400 dark:text-stone-300 text-black dark:hover:text-white">
                        ...
                        <td>pdl</td>
                        <td>:</td>
                        <td>{{$storting->anggota->pdl->nama}}</td>
                    </tr>
                    <tr class="dark:border-stone-400 dark:text-stone-300 text-black dark:hover:text-white">
                        <td>cabang</td>
                        <td>:</td>
                        <td>{{$storting->anggota->pdl->cabang->nama}}</td>
                    </tr>
