        ...
        <form class="w-full " enctype="multipart/form-data" action="/dropping" method="post">
            ...
            <div class=" flex   h-full mb-6">
                <div  class='rounded-xl  relative inline-block border-2 border-dashed p-5  text-center   '>
                    <Image  id="foto_mendatangani_spk" class="w-auto relative   rounded-xl" alt="" width={0} height={0}  objectFit="conten"></Image>
                </div>
            </div>
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full px-4">
            ...
            <div class=" flex   h-full mb-6">
                <div  class='rounded-xl  relative inline-block border-2 border-dashed p-5  text-center   '>
                    <Image   id="foto_bukti" class="w-auto relative   rounded-xl" alt="" width={0} height={0}  objectFit="conten"></Image>
                </div>
            </div>
