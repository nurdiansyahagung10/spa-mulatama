...
<td>
            ...
            stortingfetch() {
                return fetch("/api/storting/list/get", {
                    ...
                    if (response.status === 401) {
                        ...
                        response = await fetch("/api/storting/list/get", {
                            'method': 'GET',
                            'headers': {
                                'Accept': 'application/json',
                                'Authorization': `bearer ${this.accesstoken}`,
        ...
        window.addEventListener("load", async () => {
            ...
            initialstorting = new storting;
            initialcabang = new cabang;
            initialpdl = new pdl;
            listtablebodystorting.innerHTML = initialmain.load(11);
            let datafetchstorting = await initialstorting.stortingfetch();
            let datastorting = await datafetchstorting.json();
