            ...
            <tbody id="anggota-list-body-table" class="text-black/60 dark:text-stone-200">
                <script>
                    ...
                    <tr class="dark:border-stone-400 dark:text-stone-300 hover:text-black dark:hover:text-white">
                        ...
                        <td><a href="" class="dark:text-white text-black flex justify-center"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
