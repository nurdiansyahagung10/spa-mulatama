...
@include('layout.notifsuccess')
    ...
    <div style="overflow-x: auto" class="max-h-[70vh] p-10 w-full h-auto mb-10 border-b-0 rounded-t-2xl min-h-[70vh] border backdrop-blur-sm">
            ...
            <tbody id="staff-list-body-table" class="text-black/60 dark:text-stone-200">
                <script>
                    ...
                    <td colspan="6" class="h-[20rem]"><span class="loading dark:text-white loading-bars text-black loading-md"></span></td>
                        ...
                        let datafetch = await fetch("/api/user/list/get");
